        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          ...
          <AnimateIn delay={0} direction="left" className="md:col-span-2">
            <a
              ...
              className="group block relative h-full p-8 md:p-12 bg-dark/50 border border-red/30 hover:border-red/60 transition-all duration-500 overflow-hidden"
            >
              {/* Hover glow */}
              ...
              {/* "Primary" badge */}
              <div className="absolute top-0 right-0 bg-red text-white font-body text-xs uppercase tracking-wider px-4 py-1.5">
                Featured
              </div>

              <div className="relative z-10">
                <div className="text-red mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <AnimateIn delay={0.15} direction="right">
            <a
              ...
              className="group block relative h-full p-8 md:p-12 bg-dark/50 border border-dark-light/50 hover:border-red/50 transition-all duration-500 overflow-hidden"
            >
              {/* Hover glow */}
              <div className="absolute inset-0 bg-gradient-to-br from-red/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
